...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libAbsoluteGridJsx = __webpack_require__(159);

	var _libAbsoluteGridJsx2 = _interopRequireDefault(_libAbsoluteGridJsx);

	var _libTestDisplayJsx = __webpack_require__(164);

	var _libTestDisplayJsx2 = _interopRequireDefault(_libTestDisplayJsx);
	...
	function main() {
	  ...
	  */
	  var sampleItems = [{ key: 1, name: 'Test', sort: 0, filtered: 0 }, { key: 2, name: 'Test 1', sort: 2, filtered: 0 }, { key: 3, name: 'Test 2', sort: 2, filtered: 0 }, { key: 4, name: 'Test 3', sort: 3, filtered: 0 }, { key: 5, name: 'Test 4', sort: 4, filtered: 0 }, { key: 6, name: 'Test 5', sort: 5, filtered: 0 }, { key: 7, name: 'Test 6', sort: 5, filtered: 0 }, { key: 8, name: 'Test 7', sort: 6, filtered: 0 }, { key: 9, name: 'Test 8', sort: 7, filtered: 0 }, { key: 10, name: 'Test 9', sort: 8, filtered: 0 }, { key: 11, name: 'Test 10', sort: 9, filtered: 0 }, { key: 12, name: 'Test 11', sort: 10, filtered: 0 }];

	  var testDisplay = _react2['default'].createElement(_libTestDisplayJsx2['default'], null);

	  _react2['default'].render(_react2['default'].createElement(_libAbsoluteGridJsx2['default'], { items: sampleItems, itemWidth: 180, itemHeight: 60, displayObject: testDisplay }), document.getElementById('demo'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GridItemJsx = __webpack_require__(160);

	var _GridItemJsx2 = _interopRequireDefault(_GridItemJsx);

	var _LayoutManagerJs = __webpack_require__(161);

	var _LayoutManagerJs2 = _interopRequireDefault(_LayoutManagerJs);

	var _lodash = __webpack_require__(162);

	var _ = _interopRequireWildcard(_lodash);

	var AbsoluteGrid = (function (_React$Component) {
	  function AbsoluteGrid(props) {
	    _classCallCheck(this, AbsoluteGrid);

	    _get(Object.getPrototypeOf(AbsoluteGrid.prototype), 'constructor', this).call(this, props);
	    this.running = false;
	  ...
	  _inherits(AbsoluteGrid, _React$Component);

	  _createClass(AbsoluteGrid, [{
	    key: 'render',
	    value: function render() {
	      ...
	      var layout = new _LayoutManagerJs2['default'](options, this.state.layoutWidth);
	      ...
	      */
	      _.sortBy(this.props.items, 'sort').forEach(function (item) {
	        if (!item.filtered) {
	          sortedIndex[item.key] = filteredIndex;
	          filteredIndex++;
	        }
	      });
	      ...
	      var gridItems = this.props.items.map(function (item) {
	        ...
	        var index = sortedIndex[item.key];

	        return _react2['default'].createElement(_GridItemJsx2['default'], {
	          key: item.key,
	          index: index,
	          item: item,
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { style: gridStyle, className: 'absoluteGrid' },
	        gridItems
	      );
	    }
	  }, {
	    ...
	    value: function getDOMWidth() {
	      var width = _react2['default'].findDOMNode(this).clientWidth;
	...
	AbsoluteGrid.propTypes = {
	  ...
	  responsive: _react2['default'].PropTypes.boolean,
	  keyProp: _react2['default'].PropTypes.string,
	  sortProp: _react2['default'].PropTypes.string,
	  filterProp: _react2['default'].PropTypes.string
	};
	...
	var GridItem = (function (_React$Component) {
	  ...
	  _createClass(GridItem, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { style: itemStyle, className: 'gridItem' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestDisplay = (function (_React$Component) {
	  ...
	  _inherits(TestDisplay, _React$Component);

	  _createClass(TestDisplay, [{
	    key: 'render',
	    value: function render() {
	      var itemStyle = this.props.style;
