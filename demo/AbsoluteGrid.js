...
/***/ function(module, exports, __webpack_require__) {
	...
	var _indexJs = __webpack_require__(159);

	var _indexJs2 = _interopRequireDefault(_indexJs);

	var _demoTestDisplayJsx = __webpack_require__(165);

	var _demoTestDisplayJsx2 = _interopRequireDefault(_demoTestDisplayJsx);

	var _demoSampleDataJs = __webpack_require__(166);

	var data = _interopRequireWildcard(_demoSampleDataJs);
	...
	function demo() {
	  ...
	  */
	  ...
	  var testDisplay = _react2['default'].createElement(_demoTestDisplayJsx2['default'], null);
	  //Most Basic Demo
	  _react2['default'].render(_react2['default'].createElement(_indexJs2['default'], { items: sampleItems, keyProp: 'abbreviation' }), document.getElementById('BasicDemo'));

	  //Using Custom Display
	  _react2['default'].render(_react2['default'].createElement(_indexJs2['default'], { items: sampleItems, keyProp: 'abbreviation', displayObject: testDisplay }), document.getElementById('DisplayObjectDemo'));
	  ...
	  var onFilter = function onFilter(event) {
	    ...
	    _react2['default'].render(_react2['default'].createElement(_indexJs2['default'], { items: sampleItems, displayObject: testDisplay, keyProp: 'abbreviation' }), document.getElementById('FilterDemo'));
	  };
	  _react2['default'].render(_react2['default'].createElement('input', { onChange: onFilter, type: 'text' }), document.getElementById('Filter'));
	  _react2['default'].render(_react2['default'].createElement(_indexJs2['default'], { items: sampleItems, displayObject: testDisplay, keyProp: 'abbreviation' }), document.getElementById('FilterDemo'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GridItemJsx = __webpack_require__(161);

	var _GridItemJsx2 = _interopRequireDefault(_GridItemJsx);

	var _LayoutManagerJs = __webpack_require__(162);
	    ...
	    value: function render() {
	      ...
	      */
	      ...
	      var gridItems = this.props.items.map((function (item) {
	        ...
	        var gridItem = _react2['default'].cloneElement(this.props.displayObject, _.assign(this.props.displayObject.props, {
	          style: style,
	          item: item,
	          index: index,
	          key: key
	...
	AbsoluteGrid.defaultProps = {
	  items: [],
	  displayObject: _react2['default'].createElement(_GridItemJsx2['default'], null),
	  keyProp: 'key',
	  filterProp: 'filtered',
	  sortProp: 'sort',
	  itemWidth: 128,
